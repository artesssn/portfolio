...
const publishedPortfolioUrl = "https://artesssn.github.io/portfolio/";
...
document.querySelectorAll("[data-action='share']").forEach((button) => {
  button.addEventListener("click", async () => {
    ...
    const shareUrl = isLocalFile ? publishedPortfolioUrl : window.location.href;
      ...
      if (copied) {
        updateShareStatus(
          isLocalFile
            ? "Copiei a apresentacao do perfil com o link publicado do portfolio."
